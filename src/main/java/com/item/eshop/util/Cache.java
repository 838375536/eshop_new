...
public class Cache {
    ...
    public static void addUserIds(String userId){
        Jedis jedis = connectRedis();
        jedis.sadd("userIds",userId);
    }
    public static void removeUserIds(String userId){
        Jedis jedis = connectRedis();
        jedis.smove("userIds","userIds",userId);
    }

    public static Set<String> showUserIds(String userId){
        Jedis jedis = connectRedis();
        Set<String> res = jedis.smembers(userId);
        return res;
    }
