...
public class ShopcarController {
    ...
    @ResponseBody
    @PostMapping("/add")
    public int add(@RequestParam(value = "shopId",required = false) Integer shopId,@RequestParam(value = "shopcarGood")String shopcarGood, HttpSession httpSession) {
        ShopcarGood shopcarGood1 = (ShopcarGood)JsonObject.toObject(shopcarGood,"shopcarGood");
        if(shopId!=null){
            shopcarGoodService.deleteByExistShop(shopId);
        }
