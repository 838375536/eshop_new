...
public class AddressController {
    ...
    @ApiOperation(value="（app端）添加收获地址",notes="返回值(int型)，1：添加成功，0：添加失败")
    @ApiImplicitParams({@ApiImplicitParam(name = "address", value = "收获地址 Address 对象", required = true ,dataType = "String",paramType = "query")})
    @PostMapping("/add")
    ...
    @ApiOperation(value="（app端）删除收获地址",notes="返回值(int型)，1：删除成功，0：删除失败")
    ...
    @ApiOperation(value="（app端）更新收获地址",notes="返回值(int型)，1：更新成功，0：更新失败")
    @ApiImplicitParams({@ApiImplicitParam(name = "address", value = "收获地址 Address 对象", required = true ,dataType = "Object",paramType = "query")})
    @PostMapping("/update")
    ...
    @ApiOperation(value="（app端）根据id值查找收获地址",notes="返回值(Address对象)或NULL值")
    ...
    @ApiOperation(value="（app端）根据用户id值查找收获地址",notes="返回值(Address对象)数组或NULL值")
