...
public class GoodCategoryServiceImpl implements GoodCategoryService {
    ...
    @Override
    public List<GoodCategory> selectMore(int shop_id) {
        return goodCategoryMapper.selectMore(shop_id);
    }

    @Override
    public List<GoodCategory> selectMoreBySort(int shop_id) {
        return goodCategoryMapper.selectMoreBySort(shop_id);
    }
